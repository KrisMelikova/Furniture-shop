# Generated by Django 3.1 on 2021-07-14 10:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачен'), ('PRD', 'обрабатывается'), ('RD', 'готов к выдаче'), ('CNC', 'отменен'), ('DVD', 'доставлен')], default='FM', max_length=3, verbose_name='статус')),
